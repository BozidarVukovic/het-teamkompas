  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f9f7f4" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px" }}>
        <Link to="/kennis/kenniskaart-teamontwikkeling" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 10, background: "#fff", border: "1px solid #dde4ed", borderRadius: 18, padding: "26px 28px", boxShadow: "0 10px 28px rgba(13,27,42,0.08)", textDecoration: "none", color: "inherit", marginBottom: 28 }}>
