    ...
    <>
      ...
      <PageShell>
        <Section style={{ paddingTop: 96, paddingBottom: 56 }}>
          <Eyebrow withDot>Teamontwikkeling</Eyebrow>
          <h1 className="tk-heading-xl">Sterkere teams beginnen met beter begrijpen wat er speelt.</h1>
          <p className="tk-lead">
        ...
        <section className="tk-container tk-grid tk-grid-3" style={{ padding: "24px 24px 96px" }}>
          {[
            {
            ...
            <Card key={blok.titel} accent={PUB.teal}>
              <h2
                style={{
                  marginTop: 0,
                  marginBottom: 12,
