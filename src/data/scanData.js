...
export const DEFAULT_STELLINGEN = [
...
export const MEDEWERKERSSCAN_INTRO = "Deze vragenlijst helpt om beter te begrijpen hoe het werken binnen jouw team wordt ervaren. Er zijn geen goede of foute antwoorden. Jouw ervaring staat centraal. De uitkomsten worden gebruikt om samen te bepalen waar verbetering het meeste effect heeft.";

export const MANAGEMENTSCAN_INTRO = "Deze vragenlijst helpt inzicht te krijgen in waar de belangrijkste uitdagingen en ontwikkelpunten binnen het team liggen. Er zijn geen goede of foute antwoorden. Het doel is richting bepalen.";

export const MEDEWERKERSSCAN_STELLINGEN = [
...
export const MANAGEMENTSCAN_STELLINGEN = [
...
export function getScanTemplate(scanType = "algemeen") {
...
export const VEILIGHEID_LEIDERSCHAP_STELLINGEN = [
...
export const VEILIGHEID_LEIDERSCHAP_INTERPRETATIE = [
...
export const VEILIGHEID_LEIDERSCHAP_REFLECTIEVRAGEN = [
...
export const VERBETEREN_LEREN_STELLINGEN = [
  // Leidinggevende — Lean
...
export const VERBETEREN_LEREN_INTERPRETATIE = [
...
export const VERBETEREN_LEREN_REFLECTIEVRAGEN = [
...
export const ENERGIE_MOTIVATIE_STELLINGEN = [
  // Deel A — taakeisen
...
export const ENERGIE_MOTIVATIE_REFLECTIEVRAGEN = [
...
export const BELEVING_VERANDERING_STELLINGEN = [
...
export const BELEVING_VERANDERING_REFLECTIEVRAGEN = [
...
export const VERDIEPING_BLOKKEN = {
